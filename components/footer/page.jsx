...
const Footer = () => {
  return (
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h1 className="font-bold text-lg uppercase text-gray-900">Product</h1>
			...
			<div className="space-y-3">
				<h1 className="font-bold text-lg uppercase text-gray-900">Company</h1>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				<h1 className="font-bold text-lg uppercase text-gray-900">Developers</h1>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				<div className="font-bold text-lg uppercase text-gray-900">Social media</div>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2023 Explode legacy. All rights reserved.</div>
</footer>
  )
}
